...
function BookDetails(props) {
    ...
    }, [props.match.params.id, props.history]); // Stable dependencies

    useEffect(() => {
        getData();
    }, [getData]); // Avoid ESLint warning
    ...
    if (data.isbn) {
        try {
            ...
            // If the specific image is not found, default image will be used
        }
    }
    ...
    return (
        <div>
            <Breadcrumb>
                <Breadcrumb.Item onClick={handleBackToBooks}>Books</Breadcrumb.Item>
                ...
                <Col sm={5}>
                    ...
                    <Row>
                        <Col md={{ span: 3, offset: 3 }}>
                            <Button variant="primary" onClick={handleBackToBooks}>Back</Button>
                        </Col>
                    </Row>
                </Col>
                <Col sm={7}>
                    ...
                    <h5>
                        <Row>
                            <Col sm={6}>
                                By <span style={{ color: 'green' }}>{data.author}</span>
                            </Col>
                            <Col sm={6} align="right">
                                {data.bestSeller && <span style={{ color: 'red' }}>Best Seller</span>}
                            </Col>
                        </Row>
                    </h5>
                    <ColoredLine color="black" />
